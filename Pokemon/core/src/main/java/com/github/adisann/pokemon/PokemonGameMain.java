...
import com.github.adisann.pokemon.audio.SoundManager;
...
public class PokemonGameMain extends Game {
    ...
    private void initShaders() {
        ...
        fadeShader = new ShaderProgram(
                Gdx.files.internal("shaders/fade/vertexshader.txt"),
                Gdx.files.internal("shaders/fade/fragmentshader.txt"));
        if (!fadeShader.isCompiled()) {
            System.out.println("Fade shader compilation failed: " + fadeShader.getLog());
            Gdx.app.exit();
        }
    ...
    public ShaderProgram getFadeShader() {
        return fadeShader;
    }
