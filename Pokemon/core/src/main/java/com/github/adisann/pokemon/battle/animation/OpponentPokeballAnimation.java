...
/**
 * Pokeball animation for the opponent.
 * Flies from right side to center.
 */
public class OpponentPokeballAnimation extends BattleAnimation {
    ...
    public OpponentPokeballAnimation() {
        super(1.5f);
    }
    ...
    public void initialize(AssetManager assetManager, TweenManager tweenManager) {
        ...
        /* pokeball being thrown - start from right (1.0f) */
        ...
        /*
         * ROTATION OF POKEBALL - Rotate counter-clockwise for variety or same?
         * Let's keep it same direction (clockwise) or make it roll -2 * 360 for coming
         * from right.
         * Moving right to left, rolling CCW (-360) looks natural.
         */
        ...
        Animation<TextureRegion> pokeballEffect = new Animation<TextureRegion>(0.025f,
                atlas.findRegions("pokeball_effect"));
        ...
        whiteMask = assetManager.get("graphics/statuseffect/white.png", Texture.class);
